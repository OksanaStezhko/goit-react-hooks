...
import Form from '../components/homework2/Form';
import ContactList from '../components/homework2/ContactList';
import Filter from '../components/homework2/Filter';

class Homework2Fonebook extends Component {
  state = {
    contacts: [
...
export default Homework2Fonebook;
